...
class FotosWeb : AppCompatActivity() {
    ...
    val imageList = ArrayList<Imagenes>()
...
/*
    private fun cargar_imagenes() {
        ...
        galeriaAdapter.AdaptadorImagenes(imageList,this)
