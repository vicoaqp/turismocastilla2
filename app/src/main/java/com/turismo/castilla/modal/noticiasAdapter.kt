    ...
    override fun onBindViewHolder(holder: noticiaViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            val dataNoticia = Intent(context, detalle_noticias::class.java)
                ...
                dataNoticia.putExtra("img_1", noticia.img_1)
                dataNoticia.putExtra("img_2", noticia.img_2)
                dataNoticia.putExtra("img_3", noticia.img_3)
                dataNoticia.putExtra("img_4", noticia.img_4)
